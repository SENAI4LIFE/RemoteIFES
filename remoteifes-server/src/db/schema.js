...
function criarSchema() {
  db.exec(`
    ...
    -- Leftover tables from the energy estimate, which was removed from the system.
    -- No code reads or writes them; they remain only to avoid a destructive migration
