  ...
  },
  {
    ...
    corpo: [
      ...
      { t: "tabela", cabecalho: ["Estado do dispositivo", "Significado"], linhas: [
        ...
        ["falhou", "erro antes de gravar (download, hash, conexão); o firmware em execução não foi tocado"],
        ["revertido", "gravou, não passou na autovalidação e voltou na versão anterior"],
        ["sem confirmação", "gravou e não voltou a se conectar; exige conferência no local"],
      ...
      { t: "nota", nivel: "atencao", texto: "A reversão é do próprio ESP32, pelo esquema A/B. O servidor não guarda a imagem anterior e não consegue reinstalá-la: ele detecta, registra e interrompe a distribuição. Uma imagem ruim se corrige publicando uma versão maior e corrigida ou regravando por USB." },
