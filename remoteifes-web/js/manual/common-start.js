ManualContent.registrar([
  ...
  },
  {
    ...
    corpo: [
      ...
      { t: "p", texto: "Selos mostram pendências ou totais, como salas online, notificações não lidas e relatos novos. O Superadministrador também vê um resumo da saúde do serviço; os detalhes ficam em <strong>Administração &gt; Sistema &gt; Status &gt; Sistema</strong>." },
    ],
  },
  {
    id: "papeis",
